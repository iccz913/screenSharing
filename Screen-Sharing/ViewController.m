...
static NSString* const kApiKey = @"45463372";
// Replace with your generated session ID
static NSString* const kSessionId = @"2_MX40NTQ2MzM3Mn5-MTQ1MjU2MzQyODMxNn5OQ2hrbzdkSnZySm9iQkhJR1VQTnVabGp-fg";
// Replace with your generated token
static NSString* const kToken = @"T1==";

@interface ViewController () <OTSessionDelegate, OTPublisherDelegate, OTSubscriberDelegate, UIWebViewDelegate>
...
-(void) viewDidAppear:(BOOL)animated
{
    ...
    NSURL * url = [NSURL URLWithString:@"https://www.kayak.com"];
...
//    _publisher.audioFallbackEnabled = NO;
    ...
    [[TBScreenCapture alloc] initWithView:self.webView];
